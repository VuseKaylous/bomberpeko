...
public class Sprite {
    ...
    |--------------------------------------------------------------------------
     */
//    public static Sprite[] player = new Sprite[15];
    /*
    ...
    */
    ...
    public Sprite(int size, int x, int y, SpriteSheet sheet, int rw, int rh) {
        ...
        _realWidth = rw;
        _realHeight = rh;
//        player = new Sprite[5][3];
//        for (int i=0;i<3;i++) {
//            player[i] = new Sprite(DEFAULT_SIZE, 0, i, SpriteSheet.tiles, 12, 16);
//            player[1][i] = new Sprite(DEFAULT_SIZE, 1, i, SpriteSheet.tiles, 12, 16);
//            player[2][i] = new Sprite(DEFAULT_SIZE, 2, i, SpriteSheet.tiles, 12, 16);
//            player[3][i] = new Sprite(DEFAULT_SIZE, 3, i, SpriteSheet.tiles, 11, 16);
//            player[4][i] = new Sprite(DEFAULT_SIZE, 4 + i, 2, SpriteSheet.tiles, 14, 16);
//        }
        load();
    }
